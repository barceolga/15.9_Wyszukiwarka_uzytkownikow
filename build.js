...
var UsersList = function (_React$Component2) {
  ...
  _createClass(UsersList, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'app_users-list' },
        React.createElement(
          'h1',
          { className: 'app_users-title' },
          ' Github users list'
        ),
        this.users
      );
...
var User = function (_React$Component3) {
  ...
  _createClass(User, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'app_users-item' },
        React.createElement(
          'div',
          { className: 'app_users-img' },
          React.createElement('img', { src: this.props.user.avatar_url, style: { maxWidth: '100px' } })
        ),
        React.createElement(
          'h2',
          { className: 'app_users-info' },
          ' Find me on:'
        ),
        React.createElement(
          'a',
          { href: this.props.user.html_url, target: '_blank', className: 'app_users-link' },
